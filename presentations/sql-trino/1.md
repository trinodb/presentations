...
* Long established history, standardized as ISO/ANSI SQL
...
* Adding newer features and standard versions regularly
...
* Translates from Trino SQL to data source access.
...
* Translate partially to SQL of the data source
* Often use JDBC driver

> Other connectors convert to API call or other query languages, and do all
...
> Clients also orchestrate queries, run reports, and show dashboards.

-vertical
## Client examples

Command line tools, desktop, and web applications:
